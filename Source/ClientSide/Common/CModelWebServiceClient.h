...
public:
	...
	/*static */bool GetModel2 ( wchar_t* pszUrl, char* pszClientId, char** ppData, int iInstanceId = 0 ) ;
	...
	/*static */bool GetAd2 ( wchar_t* pszUrl, char* pszClientId, char** ppData, int& riSize, std::string& strUrl, int iInstanceId = 0 ) ;
